# multi_repo_analyzer/service/routes_payments.py
...
def check_ml_access():
    """Check if user has ML feature access."""
    # For now, check localStorage on frontend
    # In production, this should check database/session
    return jsonify({
        "has_access": False,  # Will be determined by frontend localStorage
        "message": "Check localStorage for payment status"
    }), 200
